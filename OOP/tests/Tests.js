(function(){
  ...
  describe("Car Class: Create a car, make it drive", function() {
    ...
    it("The car should be called 'Lexus' if no Lexus is passed as a parameter", function() {
      var gm = new Car('Lexus');
      expect(gm.name).toEqual('Lexus');
    });

    it("The car should be called 'General' if no null is passed as a parameter", function() {
      var gm = new Car(null);
      expect(gm.name).toEqual('General');
    });

    it("The car should be called 'General' if undefined is passed as a parameter", function() {
      var gm = new Car(undefined);
      expect(gm.name).toEqual('General');
    });
